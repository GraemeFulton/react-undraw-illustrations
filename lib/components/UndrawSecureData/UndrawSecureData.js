...
var UndrawSecureData = function UndrawSecureData(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 169.02, y: 94.67, width: 455.01, height: 609.12, fill: "#f2f2f2" }),
    _react2.default.createElement("rect", { x: 204.49, y: 120.36, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", {
      x: 204.49,
      y: 142.37,
      width: 156.56,
    ...
    _react2.default.createElement("rect", { x: 384.29, y: 120.36, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 408.75, y: 259.8, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 412.42, y: 273.25, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 419.76, y: 286.7, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 408.75, y: 476.29, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 412.42, y: 489.75, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 419.76, y: 503.2, width: 156.56, height: 4.89, fill: "#e0e0e0" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement("rect", { x: 206.76, y: 213.32, width: 163.72, height: 161.45, fill: "#f5f5f5" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("circle", { cx: 230.17, cy: 239, r: 11.01, fill: props.primaryColor, opacity: 0.4 })
    ),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
    ...
    _react2.default.createElement("rect", { x: 206.76, y: 429.81, width: 163.72, height: 161.45, fill: "#f5f5f5" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("circle", { cx: 230.17, cy: 455.5, r: 11.01, fill: "#bdbdbd", opacity: 0.4 })
    ),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
    ...
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", { x: 128.65, y: 645.09, width: 3.67, height: 20.79, fill: "#47e6b1" }),
      _react2.default.createElement("rect", {
        x: 269.58,
        y: 712.31,
        width: 3.67,
    ...
    _react2.default.createElement("circle", { cx: 337.81, cy: 28.62, r: 7.34, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 7.34, cy: 317.46, r: 7.34, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 863.76, cy: 120.36, r: 7.34, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 822.17, cy: 339.3, r: 7.34, fill: "#4d8af0", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 37.68, cy: 145.22, r: 7.34, fill: "#47e6b1", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 853.29, cy: 647.34, r: 7.34, fill: "#47e6b1", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 910.8, cy: 430.97, r: 7.34, fill: "#47e6b1", opacity: 0.5 }),
    _react2.default.createElement("rect", {
      x: 544.42,
      y: 601.05,
      width: 186.48,
    ...
    _react2.default.createElement("rect", { x: 546.32, y: 602.45, width: 182.24, height: 148.73, fill: props.primaryColor }),
    _react2.default.createElement("rect", { x: 546.32, y: 602.45, width: 182.24, height: 148.73, fill: "#f5f5f5" }),
    _react2.default.createElement("rect", { x: 546.32, y: 631.77, width: 182.24, height: 90.07, fill: props.primaryColor }),
    _react2.default.createElement("path", {
...
exports.default = UndrawSecureData;