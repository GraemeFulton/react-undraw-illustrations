...
var UndrawPressPlay = function UndrawPressPlay(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("circle", { cx: 174.08, cy: 129.4, r: 31.5, fill: props.primaryColor, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 108.09, cy: 54.4, r: 19.5, fill: props.primaryColor, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 925.57, cy: 114.4, r: 12, fill: props.primaryColor, opacity: 0.1 }),
    ...
    _react2.default.createElement("rect", { x: 978.67, y: 485.19, width: 20.33, height: 242.78, opacity: 0.1 }),
    _react2.default.createElement("polygon", {
    ...
    _react2.default.createElement("rect", { x: 393.66, y: 219.48, width: 294.12, height: 221.63, fill: "#ededf4" }),
    _react2.default.createElement("circle", { cx: 382.18, cy: 330.29, r: 4.82, fill: "#e6e8ec" }),
    _react2.default.createElement("circle", { cx: 700.81, cy: 330.81, r: 7.95, fill: "#e6e8ec" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("ellipse", { cx: 686.97, cy: 771.05, rx: 85.12, ry: 24.55, fill: "#5f5d7e" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("ellipse", { cx: 686.97, cy: 763.14, rx: 17.03, ry: 4.91, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 677.5, y: 633.64, width: 17.5, height: 129.5, fill: "#5f5d7e" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("rect", { x: 739.5, y: 612.14, width: 16, height: 34.07, fill: "#5f5d7e" }),
    _react2.default.createElement("ellipse", { cx: 170.24, cy: 470.71, rx: 45.04, ry: 2.89, opacity: 0.1 }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("rect", { x: 150.3, y: 458.44, width: 43.81, height: 11.52, fill: "#474157" }),
    _react2.default.createElement("rect", { x: 143.34, y: 421, width: 57.24, height: 40.2, fill: "#474157" }),
    _react2.default.createElement("rect", { x: 149.88, y: 458.44, width: 43.81, height: 11.52, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 143.16, y: 421.01, width: 57.24, height: 40.2, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 153.18, y: 458.44, width: 43.81, height: 11.52, fill: "#474157" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("circle", { cx: 163.74, cy: 372.87, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 163.62, cy: 379.6, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 205.39, cy: 374.19, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 171.78, cy: 408.64, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 202.39, cy: 385.36, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 187.51, cy: 400.24, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 168.66, cy: 375.75, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 201.43, cy: 378.52, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 196.51, cy: 389.68, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 181.38, cy: 407.56, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 178.26, cy: 400.48, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 170.82, cy: 384.52, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 153.18, y: 458.44, width: 43.81, height: 4.21, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 146.22, y: 421, width: 57.24, height: 40.2, fill: "#474157" }),
    _react2.default.createElement("circle", { cx: 183.3, cy: 414.04, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 174.66, cy: 415.84, r: 1.44, opacity: 0.1 }),
    _react2.default.createElement("path", {
...
exports.default = UndrawPressPlay;