...
var UndrawBlankCanvas = function UndrawBlankCanvas(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 599.77, y: 392.2, width: 21.07, height: 7.93, fill: "#b77b7f" }),
    _react2.default.createElement("polygon", {
    ...
    _react2.default.createElement("rect", { x: 466.6, y: 119.3, width: 283.36, height: 271.7, fill: "#fff" }),
    _react2.default.createElement("path", {
      d: "M714.33,61.44v65.61H703.28V61.44a5.53,5.53,0,1,1,11.05,0Z",
      transform: "translate(-100.52 -33.01)",
      fill: "#dda2a6"
    }),
    _react2.default.createElement("rect", { x: 602.75, y: 88.07, width: 11.06, height: 5.97, opacity: 0.1 }),
    _react2.default.createElement("path", {
      d: "M718.67,125.56v21.66H699V125.56a2.68,2.68,0,0,1,2.69-2.69H716A2.69,2.69,0,0,1,718.67,125.56Z",
      transform: "translate(-100.52 -33.01)",
      fill: "#dda2a6"
    }),
    _react2.default.createElement("circle", { cx: 608.28, cy: 103.61, r: 4.18, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 608.28, cy: 102.71, r: 4.18, fill: "#b77b7f" }),
    _react2.default.createElement("rect", { x: 598.42, y: 111.53, width: 19.73, height: 2.69, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 590.35, y: 115.12, width: 35.87, height: 5.98, opacity: 0.1 }),
    _react2.default.createElement("rect", { x: 590.35, y: 113.32, width: 35.87, height: 5.98, fill: "#dda2a6" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("rect", { x: 599.77, y: 392.2, width: 21.07, height: 3.29, opacity: 0.1 }),
    _react2.default.createElement("polygon", {
    ...
    _react2.default.createElement("circle", { cx: 387.68, cy: 206.09, r: 34.52, fill: "#efb7b9" }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("circle", { cx: 179.99, cy: 124.52, r: 31.5, fill: props.primaryColor, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 113.99, cy: 49.52, r: 19.5, fill: props.primaryColor, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 12, cy: 93.02, r: 12, fill: props.primaryColor, opacity: 0.1 })
  );
};
...
exports.default = UndrawBlankCanvas;