...
var UndrawOnlineShopping = function UndrawOnlineShopping(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 286.29, y: 6.19, width: 498.5, height: 26.89, fill: "#f6f7f9" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.2 },
      _react2.default.createElement("rect", { x: 286.29, y: 6.19, width: 498.5, height: 26.89, fill: props.primaryColor })
    ),
    _react2.default.createElement("rect", { x: 286.29, y: 33.08, width: 498.5, height: 666.19, fill: "#f6f7f9" }),
    _react2.default.createElement("circle", { cx: 299.4, cy: 19.63, r: 4.56, fill: "#f6f7f9" }),
    _react2.default.createElement("circle", { cx: 311.76, cy: 19.63, r: 4.56, fill: "#f6f7f9" }),
    _react2.default.createElement("circle", { cx: 324.12, cy: 19.63, r: 4.56, fill: "#f6f7f9" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.2 },
      _react2.default.createElement("rect", { x: 375.26, y: 74.15, width: 320.55, height: 12.55, fill: props.primaryColor })
    ),
    _react2.default.createElement("rect", { x: 653.22, y: 74.15, width: 42.59, height: 12.55, fill: props.primaryColor }),
    _react2.default.createElement(
      "g",
      { opacity: 0.2 },
    ...
    _react2.default.createElement("circle", { cx: 642.65, cy: 188.48, r: 3.66, opacity: 0.1 }),
    _react2.default.createElement("circle", { cx: 642.65, cy: 187.56, r: 3.66, fill: props.primaryColor }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("circle", { cx: 646.07, cy: 364.87, r: 2.31, opacity: 0.1 }),
    ...
    _react2.default.createElement("circle", { cx: 146.96, cy: 735.39, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("circle", { cx: 155.8, cy: 739.77, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("circle", { cx: 160.34, cy: 741.8, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("circle", { cx: 169.77, cy: 745.42, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("circle", { cx: 164.97, cy: 743.88, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement("circle", { cx: 61.77, cy: 707.35, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("circle", { cx: 61.3, cy: 714.84, r: 0.94, fill: "#fff", opacity: 0.25 }),
    _react2.default.createElement("path", {
...
exports.default = UndrawOnlineShopping;