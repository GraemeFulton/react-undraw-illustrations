...
var UndrawNoData = function UndrawNoData(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 257.89, y: 116.91, width: 437.02, height: 603.82, fill: "#e0e0e0" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement("rect", { x: 270.65, y: 131.42, width: 411.5, height: 570.52, fill: "#fff" }),
    _react2.default.createElement("rect", {
      x: 374.87,
      y: 106.68,
      width: 204.14,
    ...
    _react2.default.createElement("rect", { x: 377.02, y: 104.56, width: 199.84, height: 47.27, fill: props.primaryColor }),
    _react2.default.createElement("path", {
    ...
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", { x: 15.27, y: 737.05, width: 3.76, height: 21.33, fill: "#47e6b1" }),
      _react2.default.createElement("rect", {
        x: 205.19,
        y: 796.65,
        width: 3.76,
    ...
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", { x: 451.49, width: 3.76, height: 21.33, fill: "#47e6b1" }),
      _react2.default.createElement("rect", {
        x: 641.4,
        y: 59.59,
        width: 3.76,
    ...
    _react2.default.createElement("circle", { cx: 812.64, cy: 314.47, r: 7.53, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 230.73, cy: 746.65, r: 7.53, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 735.31, cy: 477.23, r: 7.53, fill: "#f55f44", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 87.14, cy: 96.35, r: 7.53, fill: "#4d8af0", opacity: 0.5 }),
    _react2.default.createElement("circle", { cx: 7.53, cy: 301.76, r: 7.53, fill: "#47e6b1", opacity: 0.5 })
  );
};
