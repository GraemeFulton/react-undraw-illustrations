...
var UndrawNotes = function UndrawNotes(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 4.34, y: 4.34, width: 412.36, height: 283.23, fill: "#f7f7f7" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("circle", { cx: 71.35, cy: 100.38, r: 7.6, fill: props.primaryColor }),
      _react2.default.createElement("circle", { cx: 71.35, cy: 145.96, r: 7.6, fill: props.primaryColor }),
      _react2.default.createElement("circle", { cx: 71.35, cy: 191.53, r: 7.6, fill: props.primaryColor })
    ),
    _react2.default.createElement("rect", { x: 127.24, y: 96.04, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 127.24, y: 141.61, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 127.24, y: 187.19, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement("rect", { x: 150.84, y: 122.62, width: 412.36, height: 283.23, fill: "#f7f7f7" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("circle", { cx: 217.85, cy: 218.66, r: 7.6, fill: props.primaryColor }),
      _react2.default.createElement("circle", { cx: 217.85, cy: 264.24, r: 7.6, fill: props.primaryColor }),
      _react2.default.createElement("circle", { cx: 217.85, cy: 309.82, r: 7.6, fill: props.primaryColor })
    ),
    _react2.default.createElement("rect", { x: 273.73, y: 214.32, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 273.73, y: 259.9, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 273.73, y: 305.47, width: 230.06, height: 8.68, fill: "#e0e0e0" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement("rect", { x: 297.34, y: 240.91, width: 412.36, height: 283.23, fill: "#eee" }),
    _react2.default.createElement("circle", { cx: 364.35, cy: 336.94, r: 7.6, fill: props.primaryColor }),
    _react2.default.createElement("circle", { cx: 364.35, cy: 382.52, r: 7.6, fill: props.primaryColor }),
    _react2.default.createElement("circle", { cx: 364.35, cy: 428.1, r: 7.6, fill: props.primaryColor }),
    _react2.default.createElement("rect", { x: 420.23, y: 332.6, width: 230.06, height: 8.68, fill: "#dfdfdf" }),
    _react2.default.createElement("rect", { x: 420.23, y: 378.18, width: 230.06, height: 8.68, fill: "#dfdfdf" }),
    _react2.default.createElement("rect", { x: 420.23, y: 423.76, width: 230.06, height: 8.68, fill: "#dfdfdf" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
    ...
    _react2.default.createElement("circle", { cx: 787.66, cy: 155.08, r: 29.2, fill: "#fda57d" }),
    _react2.default.createElement("path", {
