...
var UndrawFileSearching = function UndrawFileSearching(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("rect", { x: 159.99, y: 138.39, width: 434.43, height: 581.58, fill: "#f2f2f2" }),
    _react2.default.createElement("rect", { x: 193.86, y: 162.91, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", {
      x: 193.86,
      y: 183.93,
      width: 149.48,
    ...
    _react2.default.createElement("rect", { x: 365.53, y: 162.91, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 388.88, y: 296.05, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 392.39, y: 308.89, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 399.4, y: 321.74, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 388.88, y: 502.75, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 392.39, y: 515.6, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement("rect", { x: 399.4, y: 528.44, width: 149.48, height: 4.67, fill: "#e0e0e0" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement("rect", { x: 196.03, y: 251.67, width: 156.32, height: 154.15, fill: "#f5f5f5" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("circle", { cx: 218.38, cy: 276.19, r: 10.51, fill: props.primaryColor, opacity: 0.4 })
    ),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
    ...
    _react2.default.createElement("rect", { x: 196.03, y: 458.37, width: 156.32, height: 154.15, fill: "#f5f5f5" }),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
      _react2.default.createElement("rect", {
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("circle", { cx: 218.38, cy: 482.9, r: 10.51, fill: "#bdbdbd", opacity: 0.4 })
    ),
    _react2.default.createElement(
      "g",
      { opacity: 0.5 },
    ...
    _react2.default.createElement("rect", { x: 121.45, y: 663.91, width: 3.5, height: 19.85, fill: "#47e6b1" }),
    _react2.default.createElement("rect", {
      x: 300.45,
      y: 724.45,
      width: 3.5,
    ...
    _react2.default.createElement("circle", { cx: 321.15, cy: 75.33, r: 7.01, fill: "#f55f44" }),
    _react2.default.createElement("circle", { cx: 823.31, cy: 162.91, r: 7.01, fill: "#f55f44" }),
    _react2.default.createElement("circle", { cx: 783.61, cy: 371.95, r: 7.01, fill: "#4d8af0" }),
    _react2.default.createElement("circle", { cx: 7.01, cy: 28.61, r: 7.01, fill: "#47e6b1", opacity: 0.5 })
  );
};
...
exports.default = UndrawFileSearching;