...
>
  ...
  <path
    ...
    fill="#fff"
  />
  <rect height="462.25" width="704.75" fill="#f5f5f5" x="81.49" y="183.31" />
  <rect
    height="415.88"
    width="701.76"
    fill="#e0e0e0"
    ...
    y="205.75"
  />
  <rect height="22.1" width="701.76" fill="#f5f5f5" x="84.19" y="183.65" />
  <circle cx="99.24" cy="194.37" fill="#ff5252" r="5.36" />
  <circle cx="113.97" cy="194.37" fill="#ff0" r="5.36" />
  <circle cx="128.71" cy="194.37" fill="#69f0ae" r="5.36" />
  ...
  <path
    ...
    transform="translate(-149.95 -101.66)"
  />
  <circle cx="81.78" cy="631.94" fill="#e0e0e0" r="4.54" />
  <circle cx="95.41" cy="631.94" fill="#e0e0e0" r="4.54" />
  <circle cx="109.03" cy="631.94" fill="#e0e0e0" r="4.54" />
  <path
    ...
    fill="#6c63ff"
  />
  <circle cx="436.28" cy="179.39" fill="#333" r="142.22" />
  <path
  ...
  <path
    ...
    transform="translate(-149.95 -101.66)"
  />
  <circle cx="436.28" cy="210.26" fill="#fdb797" r="142.22" />
  <path
  ...
  <rect height="189.79" width="271.28" fill="#fff" x="625.04" y="2.36" />
  <rect height="5.64" width="214.95" fill="#e0e0e0" x="655.59" y="30.26" />
  <rect height="5.64" width="147.78" fill="#e0e0e0" x="655.59" y="55.66" />
  <rect height="5.64" width="177.34" fill="#e0e0e0" x="655.59" y="81.05" />
  <rect height="5.64" width="142.41" fill="#6c63ff" x="655.59" y="106.45" />
  <rect height="5.64" width="214.95" fill="#6c63ff" x="655.59" y="131.84" />
  <rect height="5.64" width="214.95" fill="#e0e0e0" x="655.59" y="157.24" />
  <polygon
    fill="#fff"
